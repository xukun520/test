...
# Geekhub (By id77)
^https:\/\/geekhub\.com\/checkins\/start url script-request-header nzw9314/Task/geekhub.cookie.js

# 太好购 (By id77)
^https:\/\/cxdng\.cpic\.com\.cn\/taieshop\/api\/CustomerFansInfo\/GetFansInfo url script-request-header nzw9314/Task/thg.cookie.js
